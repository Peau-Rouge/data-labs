...
CREATE TABLE cars (car_VIN VARCHAR(20), manufacturer VARCHAR(20), model VARCHAR(20), year_model INT, color VARCHAR(20), ID INT);
Alter table cars rename column ID to ID_cars;
DESCRIBE cars;

INSERT INTO cars (ID_cars, car_VIN, manufacturer, model, year_model, color) VALUES 
...
CREATE TABLE customers (ID_customerstable INT, customer_id BIGINT, name_cust VARCHAR(20), phone_num VARCHAR(20), email VARCHAR(30), 
	address VARCHAR(50), city VARCHAR(20), state_province VARCHAR(20), country VARCHAR(20), zip_postal) INT(5);
...
INSERT INTO customers (ID_customerstable, customer_id, name_cust, phone_num, email, address, city, state_province, country, zip_postal) VALUES
...
CREATE TABLE salespersons (ID INT, staff_id BIGINT, name_salespers VARCHAR(50), store VARCHAR(20));
...
CREATE TABLE invoices (ID INT, invoice_number BIGINT, date_sale VARCHAR(20), ID_cars INT, ID_customerstable INT, ID_salespersons INT;
DESCRIBE invoices;
